...
$sql="select * from pnbers order by dis";
$result=mysqli_query($con,$sql);
mysqli_close($con);
?>
<div class="container-grid">
  <table class="table table-striped table-hover table-condensed" style="background-color:lightblue;margin:10px;">
  <tr width="100%" style="color:hotpink"><th style="text-align:center">Patna-Ernakulam Express </th></tr></table>
<table class="table table-striped table-hover table-condensed" style="background-color:lightblue;margin:10px;">
<!--<tr width="100%" style="color:hotpink"><th>Patna-Ernakulam Express </th></tr>-->
